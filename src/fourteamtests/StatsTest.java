...
public class StatsTest {
    ...
    public void getAlexWinsDistributionsTest() {
        ...
        int[] actual = FourTeamStats.getWinsDistribution(schedules, 2015, SnipperPlayers.ALEX);
    ...
    public void getRyanWinsDistributionsTest() {
        ...
        int[] actual = FourTeamStats.getWinsDistribution(schedules, 2015, SnipperPlayers.RYAN);
    ...
    public void getBilalWinsDistributionsTest() {
        ...
        int[] actual = FourTeamStats.getWinsDistribution(schedules, 2015, SnipperPlayers.BILAL);
    ...
    public void getFredWinsDistributionsTest() {
        ...
        int[] actual = FourTeamStats.getWinsDistribution(schedules, 2015, SnipperPlayers.FRED);
    ...
    public void simSeasonTest() {
        Set<FantasySchedule> schedules = FantasySchedule.createSchedulesNonRecursive(SnipperPlayers.BILAL);
        Map<SnipperPlayers, Integer> acutal = FourTeamStats.simSeason(schedules, 2015, SnipperPlayers.BILAL);
